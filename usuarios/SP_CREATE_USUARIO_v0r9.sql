...
CREATE PROCEDURE SP_CREATE_USUARIO(IN userData JSON)
BEGIN
    ...
    BEGIN
		...
		SET vSentencia = CONCAT("ERROR 1062: INSERT INTO usuarios_tb(usuario, nombre, email, telefono, imagen, tipo, restriccion_sucursal, sucursalid)  VALUES ('",data_usuario,"','",data_nombre,"','",data_email,"','",data_telefono,"','",data_imagen,"',",data_tipo,",",data_restriccion_sucursal,",",data_sucursalid,")");
